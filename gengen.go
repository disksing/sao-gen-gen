  ...
  <body>
    <div class="container" id="app">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="ml-auto">
          <a href="https://github.com/disksing/sao-gen-gen">
    ...
    <footer style="position: absolute; bottom: 0; width: 100%; line-height: 50px; background-color: #f5f5f5; text-align: center;">
      <div class="container">
